        ...
        <div className="footer-grid">
          ...
          <div className="footer-col">
            ...
            <div className="footer-list">
              ...
              {isDevServices ? (
                <>
                  <a href="https://www.linkedin.com/" target="_blank" rel="noreferrer" style={{ display: 'inline-flex', alignItems: 'center', gap: '0.5rem' }}>
                  ...
                  <a href="https://www.instagram.com/" target="_blank" rel="noreferrer" style={{ display: 'inline-flex', alignItems: 'center', gap: '0.5rem' }}>

        ...
        <div className="footer-grid">
          ...
          <div className="footer-col">
            ...
            <div className="footer-list">
              ...
              {isDevServices ? (
                <>
                  <a href="https://www.linkedin.com/in/dxbsaqlain405?utm_source=share_via&utm_content=profile&utm_medium=member_android" target="_blank" rel="noreferrer" style={{ display: 'inline-flex', alignItems: 'center', gap: '0.5rem' }}>
                  ...
                  <a href="https://www.facebook.com/DxbSqlnch0" target="_blank" rel="noreferrer" style={{ display: 'inline-flex', alignItems: 'center', gap: '0.5rem' }}>
                    <svg viewBox="0 0 24 24" width="16" height="16" fill="currentColor" style={{ color: '#1877F2' }}>
